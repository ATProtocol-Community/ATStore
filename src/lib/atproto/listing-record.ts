...
function normalizeListingCategorySlugs(row: StoreListing): Array<string> {
...
export type ListingDetailBlobOverrides = {
  ...
  screenshots?: Array<ListingDetailInMemoryImage>;
  /**
...
function takeExistingScreenshotsInUrlOrder(
  desiredUrls: Array<string>,
  existing: Array<AtprotoBlob>,
  ...
  const queues = new Map<string, Array<AtprotoBlob>>();
