...
import {
  HOME_PAGE_HERO_ART_SPECS,
  getHomePageHeroArtPrompt,
} from "../src/lib/home-page-hero-art";

const GEMINI_IMAGE_MODEL = "gemini-3.1-flash-image-preview" as const;
const OUTPUT_DIR = path.resolve(
  process.cwd(),
  "public/generated/home-page-heroes",
);
...
function printHelp() {
  console.log(`
Usage: npm run generate:home-page-hero-images -- [options]
