...
function runStreaming(cmd: string, args: string[]) {
...
async function main() {
  console.log('\x1b[1mat.store local dev setup\x1b[0m')
  await ensureEnvFile()
  ...
  await runMigrations()
  await runSeed()
  console.log('\n\x1b[1;32m✓ Setup complete.\x1b[0m  Next: \x1b[1mpnpm dev\x1b[0m')
}
